...
class PqgTable2 extends StatefulWidget {
  const PqgTable2({Key? key}) : super(key: key);

  @override
  _PqgTable2State createState() => _PqgTable2State();
}

class _PqgTable2State extends State<PqgTable2> {
  void initState() {
    super.initState();
